...
export type ResetInputInput = TypeOf<typeof schema>;

const UserPasswordResetForm: FC<UserAuthFormProps> = ({
  className,
  ...props
}) => {
  ...
  const methods = useForm<ResetInputInput>({
  ...
  const onSubmit = async (data: ResetInputInput) => {
